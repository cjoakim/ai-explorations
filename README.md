...
Projects and files in this repo:

- [dotnetx](dotnetx/): DotNet/C# examples
- [pythonx](pythonx/): Python examples
...
- [Ollama](https://ollama.com/)
    - [See ollama.md in this repo](pythonx/docs/ollama.md)
...
- [Anthropic: Model Context Protocol (MCP) Introduction](https://modelcontextprotocol.io/introduction)
...
- [GitHub Repos](https://github.com/cjoakim?tab=repositories)

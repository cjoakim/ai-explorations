"""
Usage:
  python main_aoai.py <func>
  python main_aoai.py check_env
  python main_aoai.py generate_embedding
  python main_aoai.py generate_completion
  python main_aoai.py generate_completion_with_md_prompt
  python main_aoai.py generate_completion_with_chatml_prompt
Options: 
